...
- Desktop bundle uploads include `diamond-desktop-artifacts.manifest.json`,
  generated by `npm run desktop:write-artifact-manifest`, with source commit,
  versions, platform, requested bundles, file sizes, and SHA-256 hashes.
