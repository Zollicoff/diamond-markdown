...
highlights, strikethrough, simple Markdown tables, and safe vault-local asset
embed lines such as `![[Images/roof.png]]` or `![Roof](Images/roof.png)`, while
leaving the raw card text editable. Canvas group
