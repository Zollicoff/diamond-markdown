...
| Render pipeline | Done | KaTeX, Mermaid, code highlighting, footnotes, embeds, callouts, block IDs, hidden Obsidian comments in Live Preview/Read/publish | Continue adding edge cases only when imported vaults expose them |
