...
| Render pipeline | Done | KaTeX, Mermaid, code highlighting, footnotes, embeds, callouts, block IDs, hidden Obsidian comments | Continue adding edge cases only when imported vaults expose them |
