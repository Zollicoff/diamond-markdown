...
- Sync (`src/lib/server/git-sync.ts`) wraps remote Git operations with remote health checks, clean-worktree, fast-forward, divergence guards, and write blocking when the last fetched remote is behind or diverged
